...
public class SnowflakeIdWorker {
	...
	public static String yyyymmdd2yyyyddd(String yyyymmdd) throws ParseException {
		SimpleDateFormat sdf1 = new SimpleDateFormat("yyyyMMdd");
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyyyDDD");

		return sdf2.format(sdf1.parse(yyyymmdd));
	}
	...
	public static int getJulianBizDate() {
		String date = getCurrentDay();
		int result = 0;
		try {
			result = Integer.parseInt(yyyymmdd2yyyyddd(date));
	...
	public synchronized String getTempId() {
		return String.valueOf(getJulianBizDate() * 10000l + String.valueOf((int)(((Math.random()*9+1)*1000))));
	}
	...
	//public static void main(String[] args) {
		...
		// System.out.println(getJulianBizDate() +
		// String.valueOf((int)(((Math.random()*9+1)*1000))));
		// System.out.println(idWorker.nextId());
		// System.out.println(idWorker.getTempId());
		// String.valueOf(getJulianBizDate() * 1000000l + Math.random());
